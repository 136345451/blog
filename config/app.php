...
return [
    ...
    'web_des_iv' => '32345136',
    //jwt加密秘钥，这一项不用修改
    'jwt_key' => 'aUzWovHtys1gyw98/LuFz2jO9twEWTV8Fu7uxu4pHxrb6fraxyrQjAGDjqeEg7YHbC8=',
    //使用富文本的参数名，请不要和其他参数重名。示例：['a', 'b']
    'richTextParams' => [],
    /****************************自定义配置（全局）End****************************************/
    ...
    */
    ...
    'aliases' => [
        ...
        'AuthApi' => Illuminate\Support\Facades\Auth::class,
        ...
        'KafkaService' => App\Common\Service\V1\KafkaService::class,
        'RecordLogsProduct'=>App\Jobs\RecordLogsProduct::class
    ],
